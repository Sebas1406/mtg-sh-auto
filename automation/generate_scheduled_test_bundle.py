...
SPECS: dict[str, CommanderSpec] = {
    ...
    "muldrotha": CommanderSpec(
        key="muldrotha",
        commander="Muldrotha, the Gravetide",
        bracket=4,
        playstyle="Sultai graveyard value de permanentes reciclables, self-mill y loops suaves",
        difficulty="Alta",
        price_value="$10.49",
        price_url="https://www.cardkingdom.com/mtg/dominaria/muldrotha-the-gravetide",
        summary="Muldrotha convierte el cementerio en una mano adicional permanente. El mazo juega por desgaste, reusando tierras, artefactos, criaturas y encantamientos hasta que cada turno genera mucho más valor que el resto de la mesa.",
        early="Acelera con self-mill suave, rocas y tierras utilitarias. Muldrotha quiere un cementerio poblado antes de entrar para que el primer turno ya recicle algo relevante.",
        mid="Con Muldrotha activa, Sakura-Tribe Elder, Seal of Primordium, Executioner's Capsule y permanentes de valor se convierten en recursos repetibles. La mesa entra en modo grind muy rápido.",
        late="El cierre llega por superioridad de recursos, por loops con Strip Mine o por criaturas grandes reusadas turno tras turno. No hace falta combo duro si nadie puede seguir el ritmo del graveyard.",
        notes=["Comandante nuevo respecto a todo lo ya publicado.","Muy buen candidato para contenido porque el cementerio como segunda mano se explica muy fácil.","Su identidad visual mezcla permanentes útiles y value incremental."],
        risks=["Sufre muchísimo contra hate al cementerio bien colocado.","La curva puede sentirse pesada si no aparece setup temprano.","Requiere buena secuencia de tipos de permanente para optimizar cada turno."],
        deck_sections={
            "Criaturas": ["Stitcher's Supplier","Sakura-Tribe Elder","Satyr Wayfinder","Baleful Strix","Glowspore Shaman","Ramunap Excavator","Eternal Witness","Solemn Simulacrum","Plaguecrafter","Ravenous Chupacabra","World Shaper","Acidic Slime","Titania, Protector of Argoth","Agent of Treachery","Sepulchral Primordial"],
            "Artefactos": ["Sol Ring","Arcane Signet","Dimir Signet","Golgari Signet","Simic Signet","Executioner's Capsule","Nihil Spellbomb","Mind Stone"],
            "Encantamientos": ["Seal of Primordium","Animate Dead","Dance of the Dead","Deadbridge Chant","Mystic Remora"],
            "Instantaneos": ["Assassin's Trophy","Beast Within","Krosan Grip","Reality Shift"],
            "Conjuros": ["Cultivate","Kodama's Reach","Life from the Loam","Living Death","Splendid Reclamation"],
            "Tierras": ["Command Tower","Zagoth Triome","Watery Grave","Breeding Pool","Overgrown Tomb","Bojuka Bog","Cephalid Coliseum","Strip Mine","Polluted Delta","Forest","Island","Swamp"],
        },
    ),
    "jetmir": CommanderSpec(
        key="jetmir",
        commander="Jetmir, Nexus of Revels",
        bracket=4,
        playstyle="Naya go-wide de tokens, anthems explosivos y cierres por combate",
        difficulty="Media",
        price_value="$6.49",
        price_url="https://www.cardkingdom.com/mtg/streets-of-new-capenna/jetmir-nexus-of-revels",
        summary="Jetmir convierte una mesa ancha en una sentencia de combate. El mazo busca llenar el campo con tokens y cuerpos baratos hasta que un turno con Jetmir hace que todo gane stats, vigilancia, trample y double strike.",
        early="Desarrolla productores de tokens y aceleración. Jetmir no necesita entrar pronto; necesita una mesa suficientemente ancha para cerrar de golpe.",
        mid="Adeline, Myrel, Avenger y cartas tipo Secure the Wastes o March of the Multitudes construyen la masa crítica. Cada cuerpo adicional se siente mejor que el anterior.",
        late="Con nueve criaturas en mesa, Jetmir vuelve cualquier ataque en letal. Si el combate se complica, los anthem effects y los tokens inevitables sostienen la presión.",
        notes=["Comandante nuevo y muy distinto a todo lo ya generado.","Excelente para TikTok por el contraste entre mesa pequeña y cierre explosivo.","El plan es lineal pero muy visual."],
        risks=["Wraths a destiempo castigan mucho.","Sin generadores de tokens, Jetmir puede llegar sin suficiente impacto.","Depende bastante del paso de combate para cerrar."],
        deck_sections={
            "Criaturas": ["Llanowar Elves","Avacyn's Pilgrim","Jinnie Fay, Jetmir's Second","Adeline, Resplendent Cathar","Myrel, Shield of Argive","Hero of Bladehold","Elspeth's Knight-Errant","Grand Crescendo","Tendershoot Dryad","Avenger of Zendikar","Leonin Warleader","Brimaz, King of Oreskos","Queen Allenal of Ruadach","Halo Fountain","Professional Face-Breaker"],
            "Artefactos": ["Sol Ring","Arcane Signet","Boros Signet","Selesnya Signet","Gruul Signet"],
            "Encantamientos": ["Impact Tremors","Anointed Procession","Cathars' Crusade","Assemble the Legion","Felidar Retreat"],
            "Instantaneos": ["Swords to Plowshares","Path to Exile","Boros Charm","Heroic Intervention"],
            "Conjuros": ["Cultivate","March of the Multitudes","Secure the Wastes","Finale of Devastation","Blasphemous Act"],
            "Tierras": ["Command Tower","Jetmir's Garden","Temple Garden","Sacred Foundry","Stomping Ground","Rogue's Passage","Forest","Plains","Mountain"],
        },
    ),
    "shorikai": CommanderSpec(
        key="shorikai",
        commander="Shorikai, Genesis Engine",
        bracket=4,
        playstyle="Azorius vehicles de value, pilots token y control flexible",
        difficulty="Media-Alta",
        price_value="$5.49",
        price_url="https://www.cardkingdom.com/mtg/kamigawa-neon-dynasty-commander/shorikai-genesis-engine",
        summary="Shorikai roba, descarta y fabrica pilotos mientras construye una mesa de vehículos difícil de interactuar. El plan es convertir cada activación en cartas reales hasta que los vehículos grandes dominen el combate.",
        early="Rocas, pilotos y vehículos baratos. Shorikai quiere empezar a activarse pronto porque corrige la mano y arma la tripulación solo.",
        mid="Con pilotos 1/1 y value engines en mesa, los vehículos empiezan a conectar mientras mantienes counters o removal abierto. El deck gana mucho jugando a velocidad flexible.",
        late="Parhelion II, Skysovereign o un board de vehículos protegidos cierran la partida. Incluso sin atacar, Shorikai puede enterrarte en cartas si nadie lo responde.",
        notes=["Comandante totalmente nuevo respecto a tus publicaciones anteriores.","El arquetipo de vehículos aporta una estética distinta para el contenido.","Muy buen deck para mostrar motor de cartas y mesa técnica."],
        risks=["Sin suficientes cuerpos, algunos vehículos se atascan.","Artifact hate bien colocado puede romper la curva.","El plan puede verse más lento que otros comandantes explosivos."],
        deck_sections={
            "Criaturas": ["Esper Sentinel","Emry, Lurker of the Loch","Sai, Master Thopterist","Aerial Surveyor","Cyberdrive Awakener","Hotshot Mechanic","Foundry Inspector","Vedalken Engineer","Stonecoil Serpent","Losheel, Clockwork Scholar","Drumbellower","Shimmer Dragon"],
            "Artefactos": ["Sol Ring","Arcane Signet","Azorius Signet","Mind Stone","Smuggler's Copter","Reckoner Bankbuster","Skysovereign, Consul Flagship","Parhelion II","Weatherlight","Unlicensed Hearse","Cultivator's Caravan","Swiftfoot Boots"],
            "Encantamientos": ["Smothering Tithe","Tezzeret's Gambit","Mechanized Production"],
            "Instantaneos": ["Swords to Plowshares","Dispatch","Counterspell","Dovin's Veto","March of Otherworldly Light"],
            "Conjuros": ["Supreme Verdict","Open the Vaults","Dance of the Manse","Organic Extinction"],
            "Tierras": ["Command Tower","Hallowed Fountain","Glacial Fortress","Adarkar Wastes","Seachrome Coast","Port Town","Otawara, Soaring City","Eiganjo, Seat of the Empire","Plains","Island"],
        },
    ),
    "korvold": CommanderSpec(
        key="korvold",
        commander="Korvold, Fae-Cursed King",
        bracket=4,
        playstyle="Jund sacrifice de treasures, draw explosivo y snowball aristocrats",
        difficulty="Media-Alta",
        price_value="$9.99",
        price_url="https://www.cardkingdom.com/mtg/throne-of-eldraine/korvold-fae-cursed-king",
        summary="Korvold convierte cada sacrificio en counter y carta, así que tesoros, fetchlands y permanentes expendables se vuelven combustible puro. El mazo quiere que todo lo que entre a mesa también sirva de recurso de salida.",
        early="Rampa con tesoros, criaturas baratas y piezas de valor. Korvold entra mejor cuando ya tienes algo listo para sacrificar ese mismo turno.",
        mid="Dockside, Mayhem Devil, Pitiless Plunderer y los outlets de sacrificio convierten cada turno en una avalancha de cartas y daño incidental.",
        late="La partida se cierra con un Korvold enorme, con loops de sacrifice o con un turno explosivo de treasures que deja a toda la mesa atrás.",
        notes=["Comandante nuevo y agresivo para variar el tipo de contenido.","Korvold produce clips muy buenos porque crece y roba al mismo tiempo.","El plan de treasures y sacrifice es muy entendible para audiencia casual."],
        risks=["Sufre si Korvold es neutralizado varias veces.","Grave hate o stax de artefactos reducen varias líneas.","Puede atraer focus inmediato de la mesa."],
        deck_sections={
            "Criaturas": ["Dockside Extortionist","Mayhem Devil","Pitiless Plunderer","Tireless Provisioner","Professional Face-Breaker","Cauldron Familiar","Gilded Goose","Llanowar Elves","Sakura-Tribe Elder","Academy Manufactor","Reclamation Sage","Marionette Master","Old Gnawbone","Ziatora, the Incinerator"],
            "Artefactos": ["Sol Ring","Arcane Signet","Rakdos Signet","Golgari Signet","Gruul Signet","Skullclamp","Ashnod's Altar","Witch's Oven"],
            "Encantamientos": ["Goblin Bombardment","Fecundity","Black Market Connections","Moldervine Reclamation"],
            "Instantaneos": ["Assassin's Trophy","Beast Within","Deadly Dispute","Village Rites"],
            "Conjuros": ["Cultivate","Jeska's Will","Victimize","Toxic Deluge","Praetor's Grasp"],
            "Tierras": ["Command Tower","Ziatora's Proving Ground","Blood Crypt","Stomping Ground","Overgrown Tomb","Phyrexian Tower","Fabled Passage","Forest","Swamp","Mountain"],
        },
    ),
    "nekusar": CommanderSpec(
        key="nekusar",
        commander="Nekusar, the Mindrazer",
        bracket=4,
        playstyle="Grixis wheels de daño pasivo, draw punisher y control de mano",
        difficulty="Media",
        price_value="$3.99",
        price_url="https://www.cardkingdom.com/mtg/commander-2013/nekusar-the-mindrazer",
        summary="Nekusar castiga el robo extra y convierte cada wheel en una ráfaga de daño para toda la mesa. El plan es acelerar al commander, forzar robos masivos y cerrar por inevitabilidad sin depender del combate.",
        early="Rocas, filtros y protección. Nekusar quiere entrar cuando ya tienes una wheel o un draw-punisher listo para que el turno siguiente sea letal en valor.",
        mid="Underworld Dreams, Fate Unraveler y Spiteful Visions hacen que cada wheel pegue muy por encima de su coste. Las manos rivales se renuevan, pero tú decides cuándo duele.",
        late="Un par de wheels encadenadas suelen bastar para rematar la mesa. Incluso si no matas de golpe, el daño pasivo deja a todos en rango rápidamente.",
        notes=["Comandante nuevo y muy distinto a los planes de combate de otras publicaciones.","Las wheels hacen el contenido muy fácil de resumir en cinco slides.","El daño no-combate amplía la variedad de la rotación."],
        risks=["La mesa suele identificar a Nekusar como amenaza inmediata.","Sin wheels, algunas piezas de castigo hacen poco por sí solas.","Puede dar demasiadas cartas al rival si no controlas bien el timing."],
        deck_sections={
            "Criaturas": ["Orcish Bowmasters","Notion Thief","Fate Unraveler","Psychosis Crawler","Kederekt Parasite","Hullbreacher Proxy","Baleful Strix","Glistening Deluge","Stormfist Crusader","Sheoldred, the Apocalypse"],
            "Artefactos": ["Sol Ring","Arcane Signet","Izzet Signet","Rakdos Signet","Dimir Signet","Howling Mine","Teferi's Puzzle Box"],
            "Encantamientos": ["Underworld Dreams","Spiteful Visions","Phyrexian Tyranny","Curiosity"],
            "Instantaneos": ["Counterspell","Cyclonic Rift","Feed the Swarm","Terminate","An Offer You Can't Refuse"],
            "Conjuros": ["Windfall","Wheel of Misfortune","Whispering Madness","Dark Deal","Reforge the Soul","Blasphemous Act"],
            "Tierras": ["Command Tower","Xander's Lounge","Watery Grave","Steam Vents","Blood Crypt","Temple of Epiphany","Temple of Deceit","Temple of Malice","Island","Swamp","Mountain"],
        },
    ),
    "meren": CommanderSpec(
        key="meren",
